...
Creature state uses schema v16. Chronicle, constellation progress, Legendary reveal, and Collection Mutation are recalculated for the requested historical date and are not stored in `~/.anti-ai/creature.json`.
