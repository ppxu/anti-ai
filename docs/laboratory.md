...
Schema v1–v10 files migrate sequentially and idempotently by preserving or adding the missing empty Laboratory, companion, or incident index. Migration never invents past experiments, bonds, imprints, anomalies, or incidents.
