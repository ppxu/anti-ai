...
function runExplain(lang = "zh", topic = undefined) {
  ...
  if (lang === "en") {
    const lines = [
      ...
      "  anti-ai codex derives 68 fixed entries plus private, foreign, fossil, selected case, culture, and companion specimens from schema v10.",
  ...
  const lines = [
    ...
    "  不使用精确 Token 作为等级条件。anti-ai codex 从 schema v10 派生 68 项固定收藏、动态/外来标本、化石、已封存病例切片、培养物和伴生异物。",
