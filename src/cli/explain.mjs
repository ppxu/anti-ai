...
function runExplain(lang = "zh", topic = undefined) {
  ...
  if (lang === "en") {
    const lines = [
      ...
      "  specimen, wanted, fossil, encounter, prognosis, culture, companion, habitat, expedition, and dossier add privacy-safe collection cards.",
  ...
  const lines = [
    ...
    "  specimen、wanted、fossil、encounter、prognosis、culture、companion、habitat、expedition、dossier 提供隐私安全的收藏卡。",
