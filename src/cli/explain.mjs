...
function runExplain(lang = "zh", topic = undefined) {
  ...
  if (lang === "en") {
    const lines = [
      ...
      "  anti-ai codex derives 68 fixed entries plus private, foreign, fossil, selected case, culture, companion, and incident-report specimens from schema v12.",
      ...
      "  State: ~/.anti-ai/creature.json (schema v12; schema v1-v11 migrate sequentially",
      ...
      "  POLLUTION, CLARITY, and PARADOX have equal pools: 18 incidents, 12 relationship",
      "  diagnoses, 12 decorations, and 18 duo titles across all routes.",
  ...
  const lines = [
    ...
    "  不使用精确 Token 作为等级条件。anti-ai codex 从 schema v12 派生 68 项固定收藏、动态/外来标本、化石、已封存病例切片、培养物、伴生异物和事故报告。",
    ...
    "  状态文件：~/.anti-ai/creature.json（schema v12；schema v1-v11 逐版本本地迁移并保留原始备份）",
    ...
    "  共 18 个事件、12 种关系诊断、12 件布景和 18 个双生称号。",
